...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_GRAVE, _______,
    ...
    [2] = LAYOUT(
        ...
        _______,   A_TILDE, _______, _______, _______, _______,  _______, _______, _______, _______, C_CEDILLA, _______, _______,
        _______,   _______, _______,    COPY,   PASTE, _______, _______, _______, _______, _______, _______,          _______, _______,
